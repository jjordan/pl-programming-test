...
#      p @@config_data
    ...
    # Checks to see if the called method exists in the config data, if
    # it does, it creates a getter method and installs it into the
    # class.  If it doesn't, it returns a ConfigError
